...
\begin{frame}[label={sec:org1a6de19}]{PWM, Schwellwert 128}
\begin{tikzpicture}
...
\begin{frame}[label={sec:org22dc7de}]{PWM, Schwellwert 16}
\begin{tikzpicture}
\begin{axis}[xlabel=Zeit / s, ylabel=Spannung / V, ymin=-0.1, ymax=5.1]
...
\begin{frame}[fragile,label={sec:org3a551dc}]{Einfacher PWM Code}
 \begin{minted}[]{c}
...
\begin{frame}[fragile,label={sec:orga6b130d}]{Datentypen (1)}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org8e4a1f5}]{Datentypen (2)}
 \begin{itemize}
...
\begin{frame}[label={sec:org9369651}]{PWM Frequenz}
...
\begin{frame}[fragile,label={sec:org4cb99c3}]{PWM Vorteiler: Timer 0, Pins 5 und 6}
 \begin{center}
\begin{tabular}{rrr}
...
\begin{frame}[fragile,label={sec:orgb7bc80e}]{PWM Vorteiler: Timer 1, Pins 9 und 10}
 \begin{center}
\begin{tabular}{rrr}
Einstellung & Teiler & Frequenz\\
\hline
...
\begin{frame}[fragile,label={sec:org414149e}]{PWM Vorteiler: Timer 2, Pins 11 und 3}
 \begin{center}
\begin{tabular}{rrr}
Einstellung & Teiler & Frequenz\\
\hline
...
\begin{frame}[fragile,label={sec:orgfdb695a}]{Vorsicht}
...
\begin{frame}[fragile,label={sec:org34b38c4}]{Unterbrechbare Abläufe starten (2)}
 \begin{minted}[]{c}
...
\begin{frame}[label={sec:orgffd592d}]{Prellen}
\begin{center}
\includegraphics[width=.9\linewidth]{./img/bounce.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org65fe1ea}]{Entprellen}
Auch: Debouncing
...
\section{Analog In}
\label{sec:org175a6d1}
\begin{frame}[label={sec:org4d715e1}]{Startpunkt analoger Input}
...
\begin{frame}[label={sec:orgd355415}]{Matrix}
Vorteile:
\begin{itemize}
...
\begin{frame}[label={sec:orgd25306c}]{Schieberegister}
\begin{itemize}
...
\label{sec:orgd8389f9}
\begin{frame}[label={sec:org70f30a4}]{WS2812, APA102\ldots{}}
\begin{itemize}
